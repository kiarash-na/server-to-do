---
id: LL-NN
title: <imperative step name>
level: <level number>
risk: none | low | medium | high
reversible: yes | no | partially
downtime: none | brief | expected
time: ~X min
os: any | <families covered>
---
...
## ✅ Verify it worked
<Exact read-only commands and the literal expected output. "Probably fine" is not verification.>

## 🚪 Human check
<Exactly ONE concrete gate: something the human personally sees or does before the box is checked.>

## 🧯 If it went wrong
<Rollback path. If none exists, say so loudly and point to ../../_shared/verify-and-recover.md.>
