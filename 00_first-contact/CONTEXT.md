...
## Inputs
**Working (this run):**
- `../runs/<server-name>/` — the run folder (`facts.md` holds provider, IP, OS, login details)
**Reference (every run):**
...
## Outputs
- Updated checkboxes + notes in `../runs/<server-name>/level-0.md`, one new line in `summary.md` per step
